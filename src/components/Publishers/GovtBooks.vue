<template>
  <div class="Schools__main-container StationeryList">
    <div class="Schools__first-container">
      <div class="Schools__main-title">{{editForm ? "Edit" : "Add"}} Government Books</div>
    ...
    <div class="Schools__third-container">
      <div class="Schools__main-title">Government Books Data</div>
      <div v-if="!stationery" class="Schools__loadingRed"> Not Functional ....</div>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      stationery: (state) => state.stationery.stationery.none,
